...
<form name="stdview" action="StudentServ" method="post">
<center>
 <div class="col-sm-8" style="height: 100px;">
  
            <h2 style="color: blue;">Enter Student ID:</h2>
            <div class="input-group" >
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
          
                <span class="glyphicon glyphicon-search input-group-addon" style="font-weight: bolder; color:green;"></span>
                <input type="text" name="sid" class="form-control" placeholder="Search By ID " style="width: 300px;height: 40px;"></input>
             
                
               </div><br>
               
                <input type="submit" class="btn btn-success" value="Search"/>
                       <input type="hidden" name="student" value="viewstudent"/> 
         </div>
         </center>
      </form>
</body>
