...
<div class=" list nav navbar">
    <ul class=" nav navbar-nav ">
            <li><a href="View_stu.jsp"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;VIEW STUDENT</a></li>
            <li><a href="View_fclty.jsp"><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;VIEW FACULTY</a></li>
