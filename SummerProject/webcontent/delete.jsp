     ...
     <form> 
        <div class="form-group container" style=" font-weight: bold; border: dotted 3px green ; ">    
            ...
            <div class="input-group">
                ...
                <input type="text" placeholder="password" class="form-control" style="width: 100%;" disabled="disabled">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <input type="text" placeholder="Repeat-Password" class="form-control" style="width: 100%;" disabled="disabled">
            </div>
            <br>
            <div class="input-group">
            ...
            <div style="border-top: dotted 3px grey; padding-top: 10px;">
                <div class="input-group" >
                    ...
                    <input type="text" placeholder="Line 1 (BUILDING NO, STREET ,LOCALITY)" class="form-control" disabled="disabled">
                    <input type="text" class="form-control" placeholder="Line 2 (DISTRICT , LANDMARK)" disabled="disabled">
                </div>
                <div class="input-group" style="width: 80%">
                    <label class="input-group-addon"><span style="font-weight: bolder;">STATE</span></label>
                    <input type="text" class="form-control" placeholder="State-Name" disabled="disabled">

                    <label class="input-group-addon"><span style="font-weight: bolder;">COUNTRY</span></label>
                    <input type="text"  class="form-control " placeholder="dummy"; disabled="disabled"> 
                
                    <label class="input-group-addon"><span style="font-weight: bolder;">PIN</span></label>
                    <input type="number" class="form-control" placeholder="00000" disabled="disabled">

                    <label class="input-group-addon"><span style="font-weight: bolder;">MOBILE</span></label>
                    <input type="number" class="form-control" placeholder="00000000001" disabled="disabled">
                </div>
            </div>
            <br>
            ...
            <div class="input-group" style="border-top: dotted 3px grey; padding-top: 10px;">
                ...
                <input type="text" placeholder="Name" class="form-control" style="width: 50%;" disabled="disabled">
                <br>
            </div>
            <div >
                <div class="input-group" >
